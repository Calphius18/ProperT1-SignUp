            ...
            <div className="container">
              <div className="row">
                ...
                <div className="col-md-8 col-lg-5 col-8">
                  ...
                  <p>
                    <i class="fa-solid fa-phone-volume"></i> (+84)984 245 3577
                  </p>
                  <p>
                    <i class="fa-solid fa-envelope"></i> contact@trav.com
                  </p>
                  <p>
                    <i class="fa-solid fa-location-dot"></i> 397 Lees Creek St.
                    Logansport
                  </p>
